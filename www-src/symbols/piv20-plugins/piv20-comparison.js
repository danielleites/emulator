/**
 * piv20-comparison.js — Comparison widget plugin
 * jQuery widget consumed by sym-comparison20.js orchestrator.
 * Loaded via <script> in sym-comparison20-template.html.
