/**
 * ═══════════════════════════════════════════════════════
 *  mm20-tagAnalysis.js  —  Tag Analysis Engine
 * ═══════════════════════════════════════════════════════
 *  Pure computation module: resample, normalize,
 *  correlation, statistics, model builders.
 *  No UI — consumed by mm20-tagExplorer.
 *
 *  Namespace: MM20.TagAnalysis
...
(function (root) {
    ...
    var MM = root.MM20;
    if (!MM) { console.error('[mm20-tagAnalysis] MM20 core not loaded'); return; }
