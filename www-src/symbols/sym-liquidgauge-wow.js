(function (PV) {
    ...
    symbolVis.prototype.init = function (scope, elem) {
        ...
        var SCRIPT_BASE = (function () {
            var scripts = document.querySelectorAll('script[src*="sym-liquidgauge-wow"]');
            if (scripts.length) {
        ...
        linkEl.href = SCRIPT_BASE + 'sym-liquidgauge-wow.css';
        ...
        function _applyConfig() {
            titleEl.textContent = config.Title || 'Executive Liquid Gauge';
